...
Use this reference for every request that may convert user-provided material into the Knowledge Inbox.
...
## Capture packet requirements and executor routing
...
7. Require non-empty summary and explanation/insights, explicit disclosure of any image-internal OCR/translation limitation, delegated-worker completion evidence when applicable, and successful beginning/middle/final read-back.
...
- Do not delete a lightweight rollback until source coverage, translation coverage, summary, insights, and runtime completion evidence have all passed independent verification.
